                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 h-12 bg-gray-50 border border-transparent rounded-2xl font-bold text-gray-900 outline-none focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all placeholder:font-normal"
                                />
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <textarea
                                    ...
                                    rows={2}
                                    className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-transparent rounded-2xl font-bold text-base text-gray-900 outline-none focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all resize-none placeholder:font-normal"
                                />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="City"
                                    className="w-full px-4 h-12 bg-gray-50 border border-transparent rounded-2xl font-bold text-base text-gray-900 outline-none focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all placeholder:font-normal"
                                />
                                <input
                                    name="pincode"
                                    required
                    ...
                    {cartItems.map((item) => (
                        <div key={item.id} className="flex gap-3">
                            <div className="w-12 h-12 bg-gray-50 rounded-lg border border-gray-100 overflow-hidden shrink-0">
                                <img src={item.image || item.imageUrl || 'https://placehold.co/100'} loading="lazy" className="w-full h-full object-cover" alt="" />
                            </div>
