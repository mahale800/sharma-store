        ...
        <div className="w-full pb-8 bg-slate-50 page-enter">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4 mb-8">
                    <Button variant="ghost" size="icon-sm" onClick={() => navigate(-1)} className="hover:bg-white rounded-xl"><ArrowLeft size={24} className="text-gray-700" /></Button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {cartItems.map((item) => (
                            <Card key={item.id} className="flex gap-4 md:gap-6 items-start shadow-sm relative group p-4 rounded-3xl">
                                {/* Image */}
                    ...
                    <div className="hidden lg:block lg:col-span-1">
                        <Card className="p-8 rounded-3xl sticky top-28">
            ...
            <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white/90 backdrop-blur-xl border-t border-gray-200 p-5 pb-safe rounded-t-3xl shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] z-40 animate-in slide-in-from-bottom">
                {/* Mobile Gift Toggle */}
